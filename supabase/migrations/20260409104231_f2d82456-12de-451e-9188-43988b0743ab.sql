...
-- Admins can manage all transactions (view + update status)
...
-- Admins can view and update all user_balances
...
-- Admins can manage trading bots
...
-- Admins can view all user_bots
CREATE POLICY "Admins can view all user_bots"
